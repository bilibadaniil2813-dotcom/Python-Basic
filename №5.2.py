while True:
    ...
    #  Питаємо користувача про продовження / We ask the user if they want to continue.
    continue_calc = input("виконати ще одне обчислення? [y/n]: ").strip().lower()

    if continue_calc not in ('y'):
        break
